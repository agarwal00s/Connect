...
<div class="container-fluid">            
	<div class="row">
		<div class="col-md-3 col-sm-6 col-xs-12">
			<div class="card" data-toggle="modal" data-target="#igniteDebate">
				<div class="content">
					<div class="row">
						<div class="col-xs-3">
				...
				<div class="text-center">
					<div class="row">
						<div class="col-md-4 col-xs-4">
							<br/>
							<div class="text-center">
								<btn data-toggle="modal" data-target="#viewDebate" class="btn btn-md btn-success btn-icon btn-fill"><i class="fa fa-eye"></i>VIEW</btn>
							</div>
							<br/>
						</div>
						<div class="col-md-4 col-xs-4">
